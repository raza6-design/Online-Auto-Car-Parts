	...
	<!-- special -->
				<div class="col-md-12 w3l-special-grid">
					...
					<div class="col-md-12 agileits-special-info w3-grid-1 ">
						<center><h4>ConFirmed Customized Order</h4></center>
						<p>			
<?php
	$sql  = "SELECT * FROM product LEFT JOIN product as sellerbudget ON product.productid=sellerbudget.productstypeid LEFT JOIN purchase ON purchase.productid=sellerbudget.productid LEFT JOIN producttype ON product.productstypeid=producttype.productstypeid LEFT JOIN cutomer ON product.supplierid=cutomer.customer_id WHERE product.status='Customized' AND purchase.qty>0 ";
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		$sqlimg = "SELECT * FROM productimages where productid='$rs[0]'";
